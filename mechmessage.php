...
<body>
    ...
    <div class="master-container">
       ...
       <input type="text" class="incoming_id" name="incoming_id" value="<?php echo htmlentities($result->resID)?>"><?php echo htmlentities($result->resID)?></input>
