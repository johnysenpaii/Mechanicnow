    ...
    if($result > 0){
      ...
      if($result > 0){
        ...
        if($query->rowCount()>0)
        {
          ...
          $sql="INSERT INTO customer(unique_id,custFirstname, custLastname, custAddress, custEmail, custCnumber, vehicleType, Username, Password, role)VALUES(:uniqueID,:custFirstname, :custLastname, :custAddress, :custEmail, :custCnumber, :vehicleType, :Username, :hashedPwd, :role)";
          $query=$dbh->prepare($sql);
