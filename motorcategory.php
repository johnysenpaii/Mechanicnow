                    ...
                    <table class="mechanic-all">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                <button style="color: rgb(156, 28, 150); border-radius: 8%; padding: 10px; font-size: 16px"><a  href="MotorcycleRequestPage.php?regeditid=<?php echo htmlentities($result->mechID)?>">Request</a></button>
                                </td>
                            </tr>
                        </tbody>
                        <?php $cnt=$cnt+1;}}?>
